...
class AppTest {
    ...
    void testReversedSequence() {
        CharSequence result = new ReversedSequence("text");
        assertThat(result.toString()).isEqualTo("txet");
    }

    @Test
    void testSubSequence() {
        CharSequence result = new ReversedSequence("hello");
        CharSequence subSequence = result.subSequence(1, 4);
        assertThat(subSequence.toString()).isEqualTo("lle");
    }
    ...
    void testLength() {
        ...
        assertThat(resultLength).isEqualTo(4);
    }
    // END
}
